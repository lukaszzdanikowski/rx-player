(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fs"), require("http"), require("https"), require("os"), require("path"), require("url"));
	else if(typeof define === 'function' && define.amd)
		define(["fs", "http", "https", "os", "path", "url"], factory);
	else if(typeof exports === 'object')
		exports["RxPlayer"] = factory(require("fs"), require("http"), require("https"), require("os"), require("path"), require("url"));
	else
		root["RxPlayer"] = factory(root["fs"], root["http"], root["https"], root["os"], root["path"], root["url"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_56__, __WEBPACK_EXTERNAL_MODULE_57__, __WEBPACK_EXTERNAL_MODULE_58__, __WEBPACK_EXTERNAL_MODULE_59__, __WEBPACK_EXTERNAL_MODULE_60__, __WEBPACK_EXTERNAL_MODULE_61__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RxPlayer = __webpack_require__(41);
	var createFileSourceBuffer = __webpack_require__(30);

	var _require = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./buffers/mp4\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var MP4SourceBuffer = _require.MP4SourceBuffer;
	var H264SourceBuffer = _require.H264SourceBuffer;

	RxPlayer.createHeadlessMediaSource = __webpack_require__(32);
	RxPlayer.createNodeCompatibilityModule = __webpack_require__(33);
	RxPlayer.buffers = {
	  createFileSourceBuffer: createFileSourceBuffer,
	  MP4SourceBuffer: MP4SourceBuffer,
	  H264SourceBuffer: H264SourceBuffer
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Node.prototype = {
		...
		cloneNode: (function (_cloneNode) {
			function cloneNode(_x) {
	...
	Document.prototype = {
		...
		// Introduced in DOM Level 2:
		importNode: (function (_importNode) {
			function importNode(_x2, _x3) {
				return _importNode.apply(this, arguments);
			}

			importNode.toString = function () {
				return _importNode.toString();
			};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AbstractSourceBuffer = (function (_EventEmitter) {
	  ...
	  function AbstractSourceBuffer(codec, mediaSource) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function EME(video, keySystems, _ref) {
	  var requestMediaKeySystemAccess = _ref.requestMediaKeySystemAccess;
	  var setMediaKeys = _ref.setMediaKeys;
	  var emeEvents = _ref.emeEvents;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Manifest = (function () {
	  function Manifest(manifest, compat) {
	  ...
	  Manifest.prototype.normalize = function normalize(location, subtitles) {
	    var _this = this;
	    ...
	    var periods = _.map(manifest.periods, function (period) {
	      return _this._normalizePeriod(period);
	    });
	  ...
	  Manifest.prototype._normalizePeriod = function _normalizePeriod(period) {
	    var _this2 = this;
	    ...
	    adaptations = _.map(adaptations, function (ada) {
	      return _this2._normalizeAdaptation(ada);
	    });
	  ...
	  Manifest.prototype._normalizeAdaptation = function _normalizeAdaptation(adaptation) {
	    var _this3 = this;
	    ...
	    var representations = _.map(adaptation.representations, function (rep) {
	      return _this3._normalizeRepresentation(rep, inheritedFromAdaptation);
	    }).sort(function (a, b) {
	    ...
	    if (type == "video" || type == "audio") {
	      representations = _.filter(representations, function (rep) {
	        return _this3._isCodecSupported(getCodec(rep));
	      });
	    }
	  ...
	  Manifest.prototype._normalizeRepresentation = function _normalizeRepresentation(representation, inherit) {
	  ...
	  Manifest.prototype._normalizeSubtitles = function _normalizeSubtitles(subtitles) {
	  ...
	  Manifest.prototype.mergeManifestsIndex = function mergeManifestsIndex(newManifest) {
	  ...
	  Manifest.prototype._isCodecSupported = function _isCodecSupported(codec) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function findAtomIndex(buf, atomName) {
	  ...
	  var atomNameInt;
	  if (typeof atomName == "string") atomNameInt = be4toi(boxName(atomName), 0);else atomNameInt = atomName;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
		var XMLReader = __webpack_require__(27).XMLReader;
...
/***/ function(module, exports, __webpack_require__) {
	...
	XMLReader.prototype = {
		parse: (function (_parse) {
			...
			return parse;
		})(function (source, defaultNSMap, entityMap) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AverageBitrate = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promise_ = __webpack_require__(7);
	var AbstractSourceBuffer = __webpack_require__(14);

	function createFileSourceBuffer(dirName) {

	  return (function (_AbstractSourceBuffer) {
	    _inherits(FileSourceBuffer, _AbstractSourceBuffer);

	    function FileSourceBuffer(codec) {
	      _classCallCheck(this, FileSourceBuffer);
	    ...
	    FileSourceBuffer.prototype._append = function _append(data) {
	      var _this = this;

	      return new Promise_(function (res, rej) {
	        _this.fd.write(new Buffer(data), function (err) {
	          return err ? rej(err) : res();
	        });
	      });
	    };

	    return FileSourceBuffer;
	...
	function createHeadlessMediaSource(SourceBuffer) {
	  ...
	  var URL = {
	    createObjectURL: function createObjectURL(object) {
	      ...
	      objectUrls.push({ url: url, object: object });
	      return url;
	    },

	    revokeObjectURL: function revokeObjectURL(object) {
	      for (var i = 0; i < objectUrls.length; i++) {
	        if (objectUrls[i].object === object) break;
	      }
	  ...
	  var MediaSource = (function (_EventEmitter) {
	    _inherits(MediaSource, _EventEmitter);

	    MediaSource.isTypeSupported = function isTypeSupported() {
	      return true;
	    };
	    ...
	    function MediaSource() {
	      ...
	      this._checkInited = function () {
	        var inited = _this._buffers.every(function (b) {
	          return b.inited;
	        });
	        if (inited) {
	          _this.trigger("__loadedmetadata__");
	          _this.trigger("__canPlay__");
	          _this._buffers.forEach(function (b) {
	            return b.removeEventListener("updateend", _this._checkInited);
	          });
	        }
	      };

	      this._onProgress = function () {
	        _this.trigger("__progress__");
	      };
	    }

	    MediaSource.prototype._doOpen = function _doOpen() {
	      var _this2 = this;

	      setTimeout(function () {
	        return _this2._onSourceOpen();
	      }, 0);
	    };

	    MediaSource.prototype._onSourceOpen = function _onSourceOpen() {
	      assert(this.readyState == MediaSourceReadyState.CLOSED);
	      this.readyState = MediaSourceReadyState.OPEN;
	      this.trigger("sourceopen");
	    };

	    MediaSource.prototype.addSourceBuffer = function addSourceBuffer(codec) {
	    ...
	    MediaSource.prototype.removeSourceBuffer = function removeSourceBuffer(sb) {
	      assert(this.readyState == MediaSourceReadyState.OPEN);
	    ...
	    MediaSource.prototype.dispose = function dispose() {
	      this._buffers.forEach(function (b) {
	        return b.removeEventListener();
	      });
	    };

	    MediaSource.prototype._getBuffered = function _getBuffered() {
	  ...
	  var HTMLVideoElement = (function (_EventEmitter2) {
	    _inherits(HTMLVideoElement, _EventEmitter2);
	    ...
	    HTMLVideoElement.prototype._clear = function _clear() {
	      if (this.mediasource) {
	    ...
	    HTMLVideoElement.prototype._playLoop = function _playLoop() {
	      if (!this.playing || this.readyState === 0) return;
	    ...
	    HTMLVideoElement.prototype._onLoadedMetadata = function _onLoadedMetadata() {
	      var _this3 = this;
	      ...
	      this._loop = setInterval(function () {
	        return _this3._playLoop();
	      }, 250);
	    };

	    HTMLVideoElement.prototype._awaitForSeeked = function _awaitForSeeked() {
	      var _this4 = this;
	      ...
	      var onBufferUpdateEnd = function onBufferUpdateEnd() {
	        var buffered = _this4.buffered;
	        if (buffered.hasRange(seekTo, 1)) {
	          buffers.forEach(function (b) {
	            return b.removeEventListener("updateend", onBufferUpdateEnd);
	          });
	          _this4.seeking = false;
	          _this4.trigger("seeked");
	        }
	      };

	      buffers.forEach(function (b) {
	        return b.addEventListener("updateend", onBufferUpdateEnd);
	      });
	      onBufferUpdateEnd();
	    };
	    ...
	    HTMLVideoElement.prototype.stop = function stop() {
	      throw "not implemented";
	    };

	    HTMLVideoElement.prototype.trigger = function trigger(eventName) {
	      _EventEmitter2.prototype.trigger.call(this, eventName, { type: eventName });
	    };
	    ...
	    _createClass(HTMLVideoElement, [{
	      ...
	      set: function set(url) {
	        ...
	        this.mediasource.addEventListener("__loadedmetadata__", function () {
	          return _this5._onLoadedMetadata();
	        });
	        this.mediasource.addEventListener("__canPlay__", function () {
	          return _this5.trigger("canplay");
	        });
	        this.mediasource.addEventListener("__progress__", function () {
	          return _this5.trigger("progress");
	        });
	  ...
	  return { MediaSource: MediaSource, HTMLVideoElement: HTMLVideoElement, URL: URL };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(1);
	var Promise_ = __webpack_require__(7);
	var Observable = __webpack_require__(3).Observable;
	var XMLHttpRequest = __webpack_require__(25);
	var DOMParser = __webpack_require__(26).DOMParser;

	function createCompatModule(_ref) {
	  var HTMLVideoElement = _ref.HTMLVideoElement;
	  ...
	  var sourceOpen = function sourceOpen(el) {
	    return Observable.fromEvent(el, "sourceopen");
	  };
	  var loadedMetadataEvent = function loadedMetadataEvent(el) {
	    return Observable.fromEvent(el, "loadedmetadata");
	  };
	  var isCodecSupported = function isCodecSupported() {
	    return true;
	  };
	  ...
	  if (EME) {
	    ...
	    requestMediaKeySystemAccess = function () {
	      return Promise_.reject("not implemented");
	    };
	    ...
	    emeEvents = {
	      ...
	      onKeyMessage: function onKeyMessage() {
	        return Observable["throw"]("not implemented");
	      },
	      onKeyStatusesChange: function onKeyStatusesChange() {
	        return Observable["throw"]("not implemented");
	      },
	      onKeyError: function onKeyError() {
	        return Observable["throw"]("not implemented");
	      }
	    };
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function DeviceEvents(videoElement, _ref) {
	  var visibilityChange = _ref.visibilityChange;
	  var videoSizeChange = _ref.videoSizeChange;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(9);
	var debugPane = __webpack_require__(54);
	var assert = __webpack_require__(2);

	var _require3 = __webpack_require__(19);

	var timingsSampler = _require3.timingsSampler;
	var toWallClockTime = _require3.toWallClockTime;
	var fromWallClockTime = _require3.fromWallClockTime;
	var getLiveGap = _require3.getLiveGap;

	var _require4 = __webpack_require__(35);

	var InitializationSegmentCache = _require4.InitializationSegmentCache;

	var _require5 = __webpack_require__(8);

	var BufferedRanges = _require5.BufferedRanges;

	var _require6 = __webpack_require__(43);

	var parseTimeFragment = _require6.parseTimeFragment;

	var DeviceEvents = __webpack_require__(36);
	...
	var PipeLines = __webpack_require__(40);
	var Adaptive = __webpack_require__(29);
	...
	var Player = (function (_EventEmitter) {
	  ...
	  Player.injectDefaultCompatibilityModule = function injectDefaultCompatibilityModule(defaultCompatModule) {
	    Player.__defaultCompat = defaultCompatModule;
	  };

	  function Player(options, compatModule) {
	    var _this = this;
	    ...
	    assert(compatModule, "No compatibility module injected." + "Use the injectDefaultCompatibilityModule() function");
	    ...
	    if (!videoElement) videoElement = new compatModule.HTMLVideoElement();

	    assert(videoElement instanceof compatModule.HTMLVideoElement, "requires an actual HTMLVideoElement");
	    ...
	    // fullscreen change
	    this.fullscreen = compatModule.onFullscreenChange(videoElement).subscribe(function () {
	  ...
	  Player.prototype.setFullscreen = function setFullscreen() {
	    ...
	    if (toggle === false) this.__compat.exitFullscreen();else this.__compat.requestFullscreen(this.video);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextSourceBuffer = __webpack_require__(31);

	var _require5 = __webpack_require__(16);

	var getLiveEdge = _require5.getLiveEdge;
	...
	var Manifest = _require6.Manifest;
	var mutateManifestLiveGap = _require6.mutateManifestLiveGap;
	var getAdaptations = _require6.getAdaptations;
	...
	function Stream(_ref) {
	  ...
	  var MediaSource = compat.MediaSource;
	  var URL = compat.URL;
	  var sourceOpen = compat.sourceOpen;
	  var loadedMetadataEvent = compat.loadedMetadataEvent;
	  ...
	  function createEME() {
	    if (keySystems && keySystems.length) {
	      ...
	      return compat.emeEvents.onEncrypted(videoElement).map(function () {
	  ...
	  function manifestAdapter(manifest, message) {
	    ...
	    if (isOutOfIndexError(message)) {
	      ...
	      return manifestPipeline({ url: manifest.locations[0] }).map(function (_ref5) {
	        ...
	        var newManifest = new Manifest(parsed.manifest, compat).normalize(parsed.url, subtitles).mergeManifestsIndex(manifest);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dashManifestParser = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Atom = _require.Atom;
	var findAtomIndex = _require.findAtomIndex;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function parser(manifest, contentProtectionParser) {
	  if (_.isString(manifest)) return parseFromString(manifest, contentProtectionParser);else return parseFromDocument(manifest, contentProtectionParser);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  smooth: __webpack_require__(48),
	  dash: __webpack_require__(44)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createSmoothStreamingParser = __webpack_require__(50);
	...
	var _require5 = __webpack_require__(51);

	var parseSami = _require5.parseSami;

	var _require6 = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Atom = _require.Atom;
	var findAtom = _require.findAtom;
	...
	var reads = {
	  traf: function traf(buff) {
	    ...
	    if (moof) return findAtom(moof, "traf");else return null;
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createSmoothStreamingParser() {
	  ...
	  function parser(val) {
	    if (_.isString(val)) return parseFromString(val);else return parseFromDocument(val);
	  }
